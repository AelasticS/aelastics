...
// /** Convert to UUID */
// export function toUUID(value: any, propDes: PropertyMeta, role: Role = 'prop'): any {
//     if (role === 'prop' && propDes.type === "object" && value) {
//       return value.uuid;
//     }
  
//     if (role === 'arrayElement' && propDes.itemType === "object" && value) {
//       return value.uuid;
//     }
  
//     if (role === 'setMember' && propDes.itemType === "object" && value) {
//       return value.uuid;
//     }
  
//     if (role === 'mapKey' && propDes.keyType === "object" && value) {
//       return value.uuid;
//     }
  
//     if (role === 'mapValue' && propDes.itemType === "object" && value) {
//       return value.uuid;
//     }
