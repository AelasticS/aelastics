...
export type DtoTreeTypeOfKey<C extends ObjectType<any, readonly string[]>> = C['ID_DTO_TREE']

export type DtoEntityReference<T extends ObjectType<any, readonly string[]>> = {
  ref: InstanceReference
  reference: DtoTypeOfKey<T>
}

export class EntityReference<T extends ObjectType<any, readonly string[]>> extends ComplexType<
  TypeOfKey<T>,
