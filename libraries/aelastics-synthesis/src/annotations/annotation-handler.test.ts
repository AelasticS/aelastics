...
export type ERM_AnnotationSchema = t.AnnotationSchema<
  typeof simpleOrmAnnotSchema,
  typeof objectOrmAnnotSchema,
  typeof collectionOrmAnnotSchema
>

export type ERM_Annotation<T> = t.Annotation<T, ERM_AnnotationSchema>
...
describe("test anotation handler", ()=>{
  let sumNumbers: tr.Reducer<number> = (acc: number, { instance, type }: Node, item: any) => {
