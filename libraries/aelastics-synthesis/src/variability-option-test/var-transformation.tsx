...
// import * as fmt from "./EER2RelDomainFM_type_model_textModel copy";
...
//   @VarPoint("FKName")
//   createFKName(rel: et.IRelationship): string {
//     return `fk_${rel.name}`;
//   }

//   @VarOption('createFKName', (dmf?: fmt.IDomain_FM_type, efm?: fmt.IRelationship_FM_type): boolean => {
//     return true;
//   })
//   createFKName1(rel: et.IRelationship): string {
//     return `fk_${rel.name}`;
//   }
...
//     return true;
//   })
//   createFKName2(rel: et.IRelationship): string {
//     return `fk_${rel.name}_2`;
//   }
...
//     if (this.domainConfiguration?.Infrastructure_prop_prop) {
//       return <r.Table name="Infrastructure table"></r.Table >;
//     }
