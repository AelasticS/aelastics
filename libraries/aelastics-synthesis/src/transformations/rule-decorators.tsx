...
export const E2E = function ({ input, output }: IE2EDecorator) {
    ...
    return function (target:abstractM2M<IModel,IModel>, propertyKey: string, descriptor: PropertyDescriptor) {
        // find or create E2E_Transformation
        let trE2E = <E2E_Transformation fromType= {input.name} toType={output.name}/>
