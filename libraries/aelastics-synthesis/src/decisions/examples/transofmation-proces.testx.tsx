...
import * as sm2smwdbmT
  from "../source-model-2-decision-binding-for-source/sourceModelToSourceModelWithDecisionModelBinding"
import * as sm2ddm
...
describe("Transformation Process", () => {
  ...
  it("should create a transformation context", () => {
    ...
    // const sm2ddmTransformation = new sm2ddm.SourceModelToDefaultTransforusrmationConfigurationModel(testStore, { 'bindingModel': bindingModel });
