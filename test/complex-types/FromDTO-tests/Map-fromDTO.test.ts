...
describe('fromDTO tests for Map' , () => {
  ...
  it('testing fromDTO with some values that don\'t comply with restrictions (name)' , () => {
    ...
    if (isFailure(map)) {
      ...
      expect(s).toEqual(
        'Expected [0]:undefined/name:Ivan34 to be alphabetical, got `Ivan34`\n'
      )
    }
  ...
  it('testing fromDTO with some values that comply with restrictions for type examples.MapOfCountries' , () => {
    let DTOObject = [
      [1 , {
        name : 'Serbia' , cities : [[1 , { name : 'Belgrade' , languages : [[1 , 'Serbian']] }] ,
          [2 , { name : 'Subotica' , languages : [[1 , 'Serbian'] , [2 , 'Hungarian']] }]]
      }] ,
      [2 , {
        name : 'Germany' ,
        cities : [[1 , { name : 'Berlin' , languages : [[1 , 'German'] , [2 , 'English']] }]]
      }]
    ]
  ...
  it('testing fromDTO with some values that don\'t comply with restrictions for type examples.MapOfCountries ' , () => {
    let DTOObject = [
      [1 , {
        name : 'Serbia' , cities : [[1 , { name : 'Belgrade.' , languages : [[1 , 'Serbian1']] }] ,
          [2 , { name : 'Subotica' , languages : [[1 , 'Serbian'] , [2 , 'Hungarian']] }]]
      }] ,
      [2 , {
        name : 'Germany' ,
