...
describe('Test cases for Number type', () => {
    ...
    it('should be in range of Number values', () => {
        const numberInRange = t.number.derive('numberInRange').inRange(0, 100);
        let num: number = 23;
        expect(isSuccess(numberInRange.validate(num,[]))).toBe(true);
    });
    ...
    it('should be greater than Number value', () => {
        const numberGraterThan0 = t.number.derive('numberGreaterThen').greaterThan(0);
        let num: number = 4;
    ...
    it('should be greater than or equal to Number value', () => {
        const numberGraterThanOrEqual0 = t.number.derive('numberGreaterThenOrEqual').greaterThanOrEqual(0);
        let num: number = 5;
    ...
    it('should be less than Number value', () => {
        const numberlessThan0 = t.number.derive('numberLessThen').lessThan(0);
        let num: number = -5;
    ...
    it('should be less than or equal to Number value', () => {
        const numberlessThanOrEqual0 = t.number.derive('numberLessThenOrEqual').lessThanOrEqual(0);
        let num: number = -5;
    ...
    it('should be valid for equal Number values', () => {
        const numberEqual0 = t.number.derive('numberEqual').equal(0);
        let num: number = 0;
    ...
    it('should be valid for integer Number values', () => {
        const numberInteger = t.number.derive('numberInteger').integer;
        let num: number = 3;
    ...
    it('should be valid for infinite value', () => {
        const infiniteNumber = t.number.derive('numberInfinite').infinite;
        let num: number = 3/0;
    ...
    it('should be valid for positive value', () => {
        const positiveNumber = t.number.derive('numberPositive').positive;
        let num: number = 3;
    ...
    it('should be valid for negative value', () => {
        const negativeNumber = t.number.derive('numberNegative').negative;
        let num1: number = -3;
    ...
    it('shoud be integer or infinite value in case of integer value', () => {
        const numberIntOrInf = t.number.derive('numberIntOrInf').integerOrInfinite;
        let num: number = 2;
    ...
    it('should be uint8 value', () => {
        const uint8Number = t.number.derive('numberUint8').uint8;
        let num: number = 20;
    ...
    it('should be uint16 value', () => {
        const uint16Number = t.number.derive('numberUint16').uint16;
        let num: number = 20;
    ...
    it('should be uint32 value', () => {
        const uint32Number = t.number.derive('numberUint32').uint32;
        let num: number = 20;
    ...
    it('should be int8 value', () => {
        const int8Number = t.number.derive('numberInt8').int8;
        let num: number = -8;
    ...
    it('should be int16 value', () => {
        const int16Number = t.number.derive('numberInt16').int16;
        let num: number = -8;
    ...
    it('should be int32 value', () => {
        const int32Number = t.number.derive('numberInt32').int32;
        let num: number = -8000;
...
// Combinations
    it('should be positive and in range Number value', () => {
        const numberInRange = t.number.derive('numPositiveInRange').positive.inRange(-10,50);
        let num = 5;
        expect(isSuccess(numberInRange.validate(num, []))).toBe(true);
    });
    ...
    it('should be negative, greater then and less then or equal Number value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').negative.greaterThan(-10).lessThanOrEqual(10);
        let num =-5;
    ...
    it('should not be positive, greater then and less then or equal Number value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').positive.greaterThan(-10).lessThanOrEqual(10);
        let num =-10;
    ...
    it('should be negative and uint8 Number value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').negative.int8;
        let num =-50;
        expect(isSuccess(isNumber.validate(num, []))).toBe(true);
    });

    it('should not be negative and uint8 Number value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').negative.uint8;
        let num =-50;
        expect(isSuccess(isNumber.validate(num, []))).toBe(false);
    });
    ...
    it('should not be negative and uint8 Number value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').negative.uint32;
        let num =-500000;
        expect(isSuccess(isNumber.validate(num, []))).toBe(false);
    });
    ...
    it('should not be negative and uint16 Number value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').int8.uint16;
        let num =-2;
        expect(isSuccess(isNumber.validate(num, []))).toBe(false);
    });

    it('should not be less than and equal Number value in case of \'null\' value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').lessThan(20).equal(5);
        let num =null;
        expect(isSuccess(isNumber.validate(num as unknown as number, []))).toBe(false);
    });
    // failed
    ...
    it('should be less than, equal and integer or infinite value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').lessThan(20).equal(5).integerOrInfinite;
        let num =5;
        expect(isSuccess(isNumber.validate(num, []))).toBe(true);
    });
    ...
    it('should not be less than, uint32 and integer or infinite value in case of \'undefined\' value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').lessThan(20).integerOrInfinite.uint32;
        let num =undefined;
        expect(isSuccess(isNumber.validate(num as unknown as number, []))).toBe(false);
    });

    it('should be integer, finite and greater then or equal Number value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').integer.finite.greaterThanOrEqual(10);
        let num =10;
        expect(isSuccess(isNumber.validate(num, []))).toBe(true);
    });
    ...
    it('should be int16, less than, finite and greater then or equal Number value', () => {
        const isNumber = t.number.derive('numberMultipleConstraints').int16.lessThan(100).greaterThanOrEqual(-20).finite;
        let num =50;
        expect(isSuccess(isNumber.validate(num, []))).toBe(true);
    });
    ...
    it('should be positive, in range, finite and less then or equal Number value', () => {
        const isNumber = t.number.derive('numPositiveInRange').positive.inRange(-10,50).lessThanOrEqual(10).finite;
        let num =5;
        expect(isSuccess(isNumber.validate(num, []))).toBe(true);
    });
