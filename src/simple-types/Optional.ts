...
export class OptionalTypeC<T extends TypeC<any>> extends TypeC<TypeOf<T>|undefined, DtoTypeOf<T>|undefined> {
     ...
     * toDTO
     */
    public toDTO(value:TypeOf<T>|undefined, path:Path=[], validate: boolean = true):Result<DtoTypeOf<T>> {
