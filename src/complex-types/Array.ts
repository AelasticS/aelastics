...
export class ArrayTypeC<E extends Any/*, T extends Array<TypeOf<E>>, D extends c*/>
    ...
    public toDTO(input: Array<TypeOf<E>>, path: Path=[], validate: boolean = true): Result<Array<DtoTypeOf<E>>> {
...
export const arrayOf = <T extends Any>(element: T, name: string = `Array<${element.name}>`): ArrayTypeC<T> => {
    return new ArrayTypeC<T>(
        name, element);
};