...
export class UnionTypeC<P extends Array<Any>> extends ComplexTypeC<P, TypeOf<P[number]>, DtoTypeOf<P[number]>> {
...
export const unionOf = <P extends Array<Any>>(elements: P, name: string = getUnionName(elements)) => {
