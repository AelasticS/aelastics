...
export class FunctionalTypeC<P extends Props, R extends Any> extends TypeC<FunDecl<ObjectType<P>,TypeOf<R>>, FunDecl<DtoObjectType<P>,DtoTypeOf<R>> > {
    constructor(
        name: string,
        readonly args: P,
        readonly returns:R
...
export const fun = <P extends Props, R extends Any>(name:string, args: P, returns:R): FunctionalTypeC<P, R> => new FunctionalTypeC<P, R>(name, args, returns);
